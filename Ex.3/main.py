...
#p_cam = PerspectiveCamera(position=Vec3(0, 0, 9), view_direction=Vec3(1, 0, 0), width=500, height=500, fov=40)
...
primitives3 = [
    Mesh('pyramid.obj', position=Vec3(0, 0, -1),)   # color=[1, 0, 0]) #,
    #Sphere(Vec3(0, 0, 8), 1.1, [.2, .4, .75])
]

#p_cam.render_scene(primitives3, antialiasing=True)
